...
/**
 * Foreground service that keeps [WakeWordListener] running so "Jarvis, ..."
...
class WakeWordService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        container = (application as MiniJarvisApp).container
    ...
    private fun buildNotification(text: String) =
        NotificationCompat.Builder(this, MiniJarvisApp.WAKE_WORD_CHANNEL_ID)
            .setSmallIcon(android.R.drawable.ic_btn_speak_now)
            .setContentTitle("Mini JARVIS")
            .setContentText(text)
            .setOngoing(true)
    ...
    companion object {
        ...
        private const val ACTION_STOP = "com.minijarvis.app.action.STOP_WAKE_WORD"
